...
public enum LocalizedStrings {
    ...
    static let table: [L10nKey: [AppLanguage: String]] = [
        ...
        .tabTable: [
            .english: "Table", .bulgarian: "Таблица", .croatian: "Ljestvica",
            .czech: "Tabulka", .danish: "Tabel", .dutch: "Stand",
            .estonian: "Tabel", .finnish: "Taulukko", .french: "Classement",
            .german: "Tabelle", .greek: "Βαθμολογία", .hungarian: "Tabella",
            .irish: "Tábla", .italian: "Classifica", .latvian: "Tabula",
            .lithuanian: "Lentelė", .maltese: "Tabella", .norwegian: "Tabell",
            .polish: "Tabela", .portuguese: "Classificação", .romanian: "Clasament",
            .serbian: "Табела", .slovak: "Tabuľka", .slovenian: "Lestvica",
            .spanish: "Clasificación", .swedish: "Tabell", .turkish: "Puan Durumu",
        ],
        .tabGallery: [
